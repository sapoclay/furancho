...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Página del menú del Furancho Da Pigarreira">
    <meta name="author" content="entreunosyceros.net">

    <title>Fuancho Da Pigarreira</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Furancho | Menú</a>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Aquí puedes administrar los menús que ofreces. Puedes añadir, modificar o eliminar listas de menús.</p>

          <div class="card mb-3 border-primary">
            <div class="card-header">
              <i class="fas fa-chart-area"></i>
              Lista de Menús
              <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#addMenuModal">Añadir Categoría</button>
							...
							<div class="card mb-3 border-primary">
					            <div class="card-header">
					              ...
					              <?php echo $menuRow["menuName"]; ?>
  					              ...
  					              <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#addItemModal" data-category="<?php echo $menuRow["menuName"];?>" data-menuid="<?php echo $menuRow["menuID"];?>">Añadir</button>
							...
							<?php
								...
								if ($menuItemResult = $sqlconnection->query($menuItemQuery)) {
									...
									if ($menuItemResult->num_rows == 0) {
											echo "<td colspan='4' class='text-center'>Sin productos añadidos en este Menú.</td>";
										}
									...
									die("Algo ha salido mal. Avisa al desarrollador.");
								}
							?>
							</table>
							</div>
